...
public class PreviewFragment extends Fragment implements FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * The {@link android.util.Size} of camera image frame.
     */
    private Size mImageFrameSize;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size size = mImageFrameSize == null ? Collections.max(
                        Arrays.asList(map.getOutputSizes(ImageFormat.YUV_420_888)),
                        new CompareSizesByArea()) : mImageFrameSize;
                ...
                mPreviewSize = null == mPreviewSize ? chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
                        rotatedPreviewWidth, rotatedPreviewHeight, maxPreviewWidth,
                        maxPreviewHeight, size) : mPreviewSize;
