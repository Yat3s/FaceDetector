...
public class Face {
    ...
    private final Rect mScaledBound;
    ...
    public void scale(float widthRatio, float heightRatio) {
        mScaledBound.left = (int) (widthRatio * mBounds.left);
        mScaledBound.top = (int) (heightRatio * mBounds.top);
        mScaledBound.right = (int) (widthRatio * mBounds.right);
        mScaledBound.bottom = (int) (heightRatio * mBounds.bottom);
    }
